...
export const videos = {
  vd1: { id:'vd1', title:'Lắng nghe chủ động', videoUrl:'https://www.youtube.com/watch?v=LHCob76kigA', youtubeId:'LHCob76kigA', duration:30, transcript:'Lắng nghe chủ động là kỹ năng quan trọng. Khi lắng nghe chủ động bạn cần: tập trung vào người nói, không ngắt lời, đặt câu hỏi làm rõ và phản hồi ý chính.', captions:'Phụ đề tiếng Việt (YouTube)', transcriptSegments:[{ startSec:0,endSec:9,text:'Lắng nghe chủ động giúp hiểu đúng nhu cầu người đối diện.' },{ startSec:10,endSec:14,text:'Tập trung vào người nói và quan sát ngôn ngữ cơ thể.' },{ startSec:15,endSec:22,text:'Không ngắt lời, để người nói trình bày trọn ý.' },{ startSec:23,endSec:30,text:'Đặt câu hỏi làm rõ và phản hồi lại ý chính.' }], checkpoints:[{ atSec:10, question:'Bước đầu khi lắng nghe chủ động là gì?', options:['Phản biện ngay','Tập trung vào người nói','Ghi chép mọi từ'], correctIndex:1 },{ atSec:15, question:'Hành vi nào nên tránh?', options:['Đặt câu hỏi mở','Nhìn vào người nói','Ngắt lời giữa chừng'], correctIndex:2 }] },
  vd2: { id:'vd2', title:'Kỹ năng thuyết trình', videoUrl:'https://www.youtube.com/watch?v=LHCob76kigA', youtubeId:'LHCob76kigA', duration:30, transcript:'Thuyết trình hiệu quả cần chuẩn bị kỹ nội dung, hiểu đối tượng và sử dụng giọng nói rõ ràng.', captions:'Phụ đề tiếng Việt (YouTube)', transcriptSegments:[{ startSec:0,endSec:9,text:'Thuyết trình hiệu quả bắt đầu từ cấu trúc rõ ràng.' },{ startSec:10,endSec:14,text:'Mở đầu: nêu mục tiêu và bối cảnh.' },{ startSec:15,endSec:22,text:'Thân bài: trình bày luận điểm cùng ví dụ cụ thể.' },{ startSec:23,endSec:30,text:'Kết thúc: nhấn lại thông điệp chính cần nhớ.' }], checkpoints:[{ atSec:10, question:'Phần mở đầu nên có gì?', options:['Kể chuyện dài','Nêu mục tiêu','Đọc toàn bộ slide'], correctIndex:1 },{ atSec:15, question:'Thân bài nên đi kèm với?', options:['Ví dụ cụ thể','Nhiều thuật ngữ khó','Nói nhanh hơn'], correctIndex:0 }] },
  vd3: { id:'vd3', title:'Các mối đe doạ phổ biến', videoUrl:'https://www.youtube.com/watch?v=LHCob76kigA', youtubeId:'LHCob76kigA', duration:30, transcript:'Các mối đe doạ thường gặp gồm phishing, ransomware và social engineering.', captions:'Phụ đề tiếng Việt (YouTube)', transcriptSegments:[{ startSec:0,endSec:9,text:'Phishing, ransomware và social engineering rất phổ biến.' },{ startSec:10,endSec:14,text:'Kẻ xấu thường giả danh tổ chức đáng tin cậy.' },{ startSec:15,endSec:22,text:'Chúng tạo cảm giác gấp để bạn mất cảnh giác.' },{ startSec:23,endSec:30,text:'Luôn kiểm tra link và nguồn gửi trước khi thao tác.' }], checkpoints:[{ atSec:10, question:'Dấu hiệu mạo danh thường là?', options:['Email nội bộ chuẩn','Tên gửi giống thương hiệu lớn','Không có đường link'], correctIndex:1 },{ atSec:15, question:'Kẻ tấn công hay dùng gì?', options:['Khuyến nghị học tập','Áp lực thời gian gấp','Biểu mẫu nội bộ'], correctIndex:1 }] },
  vd4: { id:'vd4', title:'Ma trận Eisenhower', videoUrl:'https://www.youtube.com/watch?v=LHCob76kigA', youtubeId:'LHCob76kigA', duration:30, transcript:'Ma trận Eisenhower chia công việc theo mức độ quan trọng và khẩn cấp.', captions:'Phụ đề tiếng Việt (YouTube)', transcriptSegments:[{ startSec:0,endSec:9,text:'Ma trận Eisenhower có 4 ô theo quan trọng/khẩn cấp.' },{ startSec:10,endSec:14,text:'Ô quan trọng + khẩn cấp: xử lý ngay.' },{ startSec:15,endSec:22,text:'Ô quan trọng + không khẩn cấp: lên lịch cụ thể.' },{ startSec:23,endSec:30,text:'Ô không quan trọng: cân nhắc ủy quyền hoặc loại bỏ.' }], checkpoints:[{ atSec:10, question:'Việc khẩn cấp và quan trọng nên?', options:['Để cuối ngày','Xử lý ngay','Ủy quyền toàn bộ'], correctIndex:1 },{ atSec:15, question:'Việc quan trọng không khẩn cấp cần?', options:['Lên lịch','Bỏ qua','Làm khi rảnh'], correctIndex:0 }] },
  vd5: { id:'vd5', title:'5 giai đoạn phát triển nhóm', videoUrl:'https://www.youtube.com/watch?v=LHCob76kigA', youtubeId:'LHCob76kigA', duration:30, transcript:'Theo Tuckman, nhóm đi qua Forming, Storming, Norming, Performing và Adjourning.', captions:'Phụ đề tiếng Việt (YouTube)', transcriptSegments:[{ startSec:0,endSec:9,text:'Mô hình Tuckman mô tả 5 giai đoạn phát triển nhóm.' },{ startSec:10,endSec:14,text:'Storming là lúc xuất hiện mâu thuẫn quan điểm.' },{ startSec:15,endSec:22,text:'Norming là giai đoạn nhóm dần ổn định cách phối hợp.' },{ startSec:23,endSec:30,text:'Performing là khi nhóm vận hành hiệu quả nhất.' }], checkpoints:[{ atSec:10, question:'Giai đoạn nhiều xung đột là?', options:['Forming','Storming','Performing'], correctIndex:1 },{ atSec:15, question:'Norming thể hiện điều gì?', options:['Nhóm tan rã','Nhóm ổn định dần','Nhóm chưa hình thành'], correctIndex:1 }] },
};

export const audios = {
  ad1: { id:'ad1', title:'Giọng nói và ngữ điệu', audioUrl:null, duration:30, transcript:'Giọng nói ảnh hưởng mạnh đến ấn tượng. Hãy điều chỉnh âm lượng vừa phải, tốc độ chính xác, nhấn nhá ở từ khóa quan trọng. Khoảng dừng ngắn sẽ giúp người nghe dễ hiểu hơn.', transcriptSegments:[{ startSec:0,endSec:9,text:'Giọng nói ảnh hưởng mạnh đến ấn tượng ban đầu.' },{ startSec:10,endSec:14,text:'Giữ âm lượng vừa phải và phát âm rõ ràng.' },{ startSec:15,endSec:22,text:'Điều chỉnh tốc độ, tránh nói quá nhanh.' },{ startSec:23,endSec:30,text:'Nhấn nhá từ khóa và dùng khoảng dừng hợp lý.' }], checkpoints:[{ atSec:10, question:'Yếu tố nào cần ưu tiên đầu tiên?', options:['Nói thật nhanh','Âm lượng và phát âm rõ','Dùng từ chuyên môn'], correctIndex:1 },{ atSec:15, question:'Tốc độ nói nên như thế nào?', options:['Càng nhanh càng tốt','Đều và vừa phải','Thật chậm mọi lúc'], correctIndex:1 }] },
  ad2: { id:'ad2', title:'Nhận diện phishing', audioUrl:null, duration:30, transcript:'Phishing thường xuất hiện qua email giả mạo. Bạn cần kiểm tra địa chỉ gửi, lỗi chính tả, yêu cầu gấp rút. Không nhấp link lạ, hãy truy cập trực tiếp trang chính thức.', transcriptSegments:[{ startSec:0,endSec:9,text:'Phishing thường đi kèm email giả mạo.' },{ startSec:10,endSec:14,text:'Hãy kiểm tra địa chỉ gửi và lỗi chính tả.' },{ startSec:15,endSec:22,text:'Cẩn trọng với yêu cầu gấp rút về thông tin cá nhân.' },{ startSec:23,endSec:30,text:'Không nhấp link lạ, nên vào trang chính thức trực tiếp.' }], checkpoints:[{ atSec:10, question:'Dấu hiệu nào đáng nghi nhất?', options:['Email nhiều lỗi chính tả','Email có logo công ty','Email đúng chính tả'], correctIndex:0 },{ atSec:15, question:'Gặp link lạ trong email, bạn nên?', options:['Nhấp thử','Chuyển cho bạn bè','Không nhấp, tự vào trang chính thức'], correctIndex:2 }] },
  ad3: { id:'ad3', title:'Kỹ thuật Pomodoro', audioUrl:null, duration:30, transcript:'Pomodoro giúp duy trì tập trung bằng chu kỳ ngắn. Bạn học 25 phút, nghỉ 5 phút. Sau 4 chu kỳ, nghỉ dài 15 đến 30 phút. Hãy loại bỏ xao nhãng trong mỗi phiên.', transcriptSegments:[{ startSec:0,endSec:9,text:'Pomodoro chia thời gian thành các chu kỳ ngắn.' },{ startSec:10,endSec:14,text:'Chu kỳ cơ bản: 25 phút làm việc, 5 phút nghỉ.' },{ startSec:15,endSec:22,text:'Sau 4 chu kỳ, bạn nghỉ dài hơn.' },{ startSec:23,endSec:30,text:'Giữ tập trung tối đa trong mỗi phiên.' }], checkpoints:[{ atSec:10, question:'Chu kỳ cơ bản của Pomodoro là?', options:['50/10','25/5','45/15'], correctIndex:1 },{ atSec:15, question:'Sau 4 chu kỳ nên làm gì?', options:['Nghỉ dài','Làm liên tục','Kết thúc ngày làm việc'], correctIndex:0 }] },
  ad4: { id:'ad4', title:'Phản hồi xây dựng', audioUrl:null, duration:30, transcript:'Phản hồi xây dựng nên theo mô hình SBI: tình huống, hành vi, tác động. Nói ngắn gọn, tập trung vào hành vi có thể thay đổi. Kết thúc bằng gợi ý cải thiện cụ thể.', transcriptSegments:[{ startSec:0,endSec:9,text:'SBI gồm Situation, Behavior, Impact.' },{ startSec:10,endSec:14,text:'Nêu đúng tình huống trước khi phản hồi.' },{ startSec:15,endSec:22,text:'Tập trung vào hành vi thay vì cá nhân.' },{ startSec:23,endSec:30,text:'Đề xuất hướng cải thiện rõ ràng, cụ thể.' }], checkpoints:[{ atSec:10, question:'Chữ B trong SBI là gì?', options:['Behavior','Benefit','Baseline'], correctIndex:0 },{ atSec:15, question:'Nên tập trung vào điều nào?', options:['Con người','Hành vi cụ thể','Cảm xúc chủ quan'], correctIndex:1 }] },
};
...
export const assignmentsCatalog = {
  as1: {
    ...
    submissionType: 'text',
    rubric: 'Rõ tình huống, mô tả hành vi cụ thể, nêu tác dụng và đề xuất cải thiện.',
    maxScore: 100,
    dueAt: null,
  },
};
