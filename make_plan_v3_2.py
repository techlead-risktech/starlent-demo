...
out_path = r"C:\Users\Marketing Team\Downloads\starlent-demo\Starlent_FE_BE_Project_Plan_v3_2.xlsx"
...
plan = [
    ...
    ("5", "Editor module parity (ưu tiên trước Learner)", [
        ("5.1", "Editor dashboard", "FE"),
        ("5.2", "Editor content catalog", "FE"),
        ("5.3", "Editor course builder CRUD", "FE"),
        ("5.3.1", "Tạo course/module/item", "BE"),
        ("5.3.2", "Sửa/Xóa/Reorder module/item", "BE"),
        ("5.4", "Permission checks cho editor routes/API", "BE"),
    ]),
    ("6", "Admin module parity (ưu tiên trước Learner)", [
        ("6.1", "Admin dashboard", "FE"),
        ("6.2", "Admin users: list/create + login verify user mới", "BE"),
        ("6.3", "Admin courses", "FE"),
        ("6.4", "Admin tenants + status/provision controls", "BE"),
        ("6.5", "Permission checks cho admin routes/API", "BE"),
    ]),
...
legend_row = 1
ws.cell(row=legend_row, column=2, value="Màu phân loại task:").font = Font(bold=True)
